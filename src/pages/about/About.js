...
function About() {
  ...
  return (
    <>
      ...
      <div
        class="parent owner-parent bg-img-cover"
        data-aos="fade-up"
        data-aos-delay="200"
      >
        <div class="container owner-cont">
          ...
          <div class="box-wrapper">
            <div class="left">
              ...
              <p>
                An MBA graduate who supervises the company's sales, marketing,
                and finance with a strategic acumen for continual growth and
                holds vast business expertise. His roles and responsibilities
                include identifying, developing, and directing the
          ...
          <div class="box-wrapper box2">
            <div class="left">
              ...
              <p>
                An Electrical Engineer who supervises the technology selections,
                installation & procurement having responsibilities include
                strategic technical direction, and of project execution. He has
                extensive experience in electrical maintenance, line
                installation up to 66 kV.
              </p>
              <Link class="button">
                <span>
                  <FaLinkedin />
